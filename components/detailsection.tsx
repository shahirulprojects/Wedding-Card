...
END:VCALENDAR`;
  ...
  return (
    <div
      ...
      className="mt-[27px] min-h-screen w-full flex items-center justify-center py-20 px-4 relative"
    >
      {/* Corner Flowers */}
      ...
      <div className="absolute top-10 -left-10 w-32 h-32 transform -scale-x-100">
        <Image
          src="\icons\flowercorner.svg"
          alt="corner flower"
          width={60}
